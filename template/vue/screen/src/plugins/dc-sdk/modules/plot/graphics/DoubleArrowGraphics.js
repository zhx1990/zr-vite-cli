...
class DoubleArrowGraphics {
  ...
  _getArrowPoints(pnt1, pnt2, pnt3, clockWise) {
    ...
    let bodyPnts = this._getArrowBodyPoints(points, neckLeftPoint, neckRightPoint, tailWidthFactor)
  ...
  _createHierarchy() {
    ...
    return new Cesium.PolygonHierarchy(
      Transform.transformWGS84ArrayToCartesianArray(
        Parse.parsePositions(rlBodyPnts.concat(rArrowPnts, bodyPnts, lArrowPnts, lrBodyPnts))
      )
    )
  }
}
