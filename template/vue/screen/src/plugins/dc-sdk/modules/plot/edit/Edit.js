...
class Edit {
  ...
  _bindEvent() {
    ...
    this.editTool.on(PlotEventType.EDIT_ANCHOR_STOP, this._onEditAnchorStop, this)
  ...
  _unbindEvent() {
    ...
    this.editTool.off(PlotEventType.EDIT_ANCHOR_STOP, this._onEditAnchorStop, this)
