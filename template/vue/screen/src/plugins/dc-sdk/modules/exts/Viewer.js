...
function updateTrackedEntity(viewer) {
  ...
  const currentPosition = Property.getValueOrUndefined(trackedEntity.position, currentTime)
  ...
  const bs = state !== BoundingSphereState.FAILED ? boundingSphereScratch : undefined
