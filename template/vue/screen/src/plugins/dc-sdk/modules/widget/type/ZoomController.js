...
class ZoomController extends Widget {
  ...
  _getCameraPosition(camera, focus, scalar) {
    ...
    let direction = Cesium.Cartesian3.subtract(focus, camera.position, cartesian3Scratch)
    let movementVector = Cesium.Cartesian3.multiplyByScalar(direction, scalar, cartesian3Scratch)
