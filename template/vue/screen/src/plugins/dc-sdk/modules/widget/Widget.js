...
class Widget {
  ...
  _enableHook() {
    ...
    if (this._enable) {
      !this._wrapper.parentNode && this._viewer.widgetContainer.appendChild(this._wrapper)
      this._bindEvent()
    } else {
      this._unbindEvent()
      this._wrapper.parentNode && this._viewer.widgetContainer.removeChild(this._wrapper)
    }
  }
