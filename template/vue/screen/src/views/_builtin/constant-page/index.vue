<template>
  <div class="wh-full flex-col-center">
    <NGradientText class="mb-24px" type="primary" :size="28"> Custom Constant Page </NGradientText>
    <RouterLink :to="{ name: routeHomePath }">
      <NButton type="primary">回到首页</NButton>
    </RouterLink>
    <NCard :bordered="false" size="small" class="mt-24px rounded-8px shadow-sm">
      <div class="flex-center py-12px">
        <NButton type="primary" class="mr-24px" :disabled="isMoving" @click="startMove">
          开始
        </NButton>
        <NButton type="error" @click="endMove">暂停</NButton>
      </div>
