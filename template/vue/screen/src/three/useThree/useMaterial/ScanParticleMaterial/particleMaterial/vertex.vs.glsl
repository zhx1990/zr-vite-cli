...
#pragma glslify: noise3D = require('../../noiseShader/noise3d')
#pragma glslify: noise4D = require('../../noiseShader/noise4d')
#pragma glslify: curleNoise = require('../../noiseShader/noiseCurl')
