define([
  ...
  './Math-0a2ac845',
], function (exports, Matrix2, Matrix3, ComponentDatatype, Check, defaultValue, Math$1) {
  'use strict'
  ...
  AttributeCompression.dequantize = function (typedArray, componentDatatype, type, count) {
    ...
    switch (componentDatatype) {
      ...
      //>>includeStart('debug', pragmas.debug);
      default:
        throw new Check.DeveloperError(`Cannot dequantize component datatype: ${componentDatatype}`)
      //>>includeEnd('debug');
    }
