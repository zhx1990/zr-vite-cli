define([
  './Transforms-b527bb09',
  './BoxGeometry-cd550612',
  './Matrix3-41c58dde',
  './Color-571a6085',
  './CylinderGeometry-bc26926d',
  './defaultValue-fe22d8c0',
  './EllipsoidGeometry-07e99d2d',
  ...
  './CylinderGeometryLibrary-7bf291b4',
], function (
  Transforms,
  BoxGeometry,
  Matrix3,
  ...
  function sphereModelMatrixAndBoundingVolume(spheres, index) {
    ...
    const sphereTranslation = Matrix3.Cartesian3.unpack(spheres, sphereIndex, scratchCartesian)
  ...
  function createPrimitive(
    ...
    for (let i = 0; i < numberOfPrimitives; ++i) {
      const primitiveModelMatrixAndBV = getModelMatrixAndBoundingVolume(primitive, i)
  ...
  function createVectorTileGeometries(parameters, transferableObjects) {
    ...
    const packedBuffer = packBuffer(indices.BYTES_PER_ELEMENT, batchedIndices, boundingVolumes)
