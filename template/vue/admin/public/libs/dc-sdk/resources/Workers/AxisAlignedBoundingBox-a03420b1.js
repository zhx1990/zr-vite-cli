define([
  ...
  './Transforms-b527bb09',
], function (exports, Matrix3, Check, defaultValue, Transforms) {
  'use strict'
  ...
  function AxisAlignedBoundingBox(minimum, maximum, center) {
     ...
     */
    this.minimum = Matrix3.Cartesian3.clone(
      defaultValue.defaultValue(minimum, Matrix3.Cartesian3.ZERO)
    )
     ...
     * @default {@link Cartesian3.ZERO}
     */
    this.maximum = Matrix3.Cartesian3.clone(
      defaultValue.defaultValue(maximum, Matrix3.Cartesian3.ZERO)
    )
  ...
  AxisAlignedBoundingBox.intersectPlane = function (box, plane) {
    ...
    intersectScratch = Matrix3.Cartesian3.subtract(box.maximum, box.minimum, intersectScratch)
    const h = Matrix3.Cartesian3.multiplyByScalar(intersectScratch, 0.5, intersectScratch) //The positive half diagonal
