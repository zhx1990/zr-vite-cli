define([
  ...
  function addEndCaps(calculatedPositions) {
    ...
    startPoint = Matrix3.Cartesian3.fromArray(rightEdge, rightEdge.length - 3, startPoint)
  ...
  function computeMiteredCorner(position, leftCornerDirection, lastPoint, leftIsOutside) {
    ...
    if (leftIsOutside) {
      ...
      leftCornerDirection = Matrix3.Cartesian3.negate(leftCornerDirection, leftCornerDirection)
      cornerPoint = Matrix3.Cartesian3.add(position, leftCornerDirection, cornerPoint)
    }
  ...
  CorridorGeometryLibrary.computePositions = function (params) {
    ...
    for (i = 1; i < length - 1; i++) {
      ...
      if (doCorner) {
        cornerDirection = Matrix3.Cartesian3.cross(cornerDirection, normal, cornerDirection)
        cornerDirection = Matrix3.Cartesian3.cross(normal, cornerDirection, cornerDirection)
