define([
  ...
  './Matrix3-41c58dde',
  './Check-6ede7e26',
  './EllipsoidOutlineGeometry-ba5c7ee2',
  './Math-0a2ac845',
  './Transforms-b527bb09',
  './Matrix2-e1298525',
  ...
  function SphereOutlineGeometry(options) {
    ...
    this._ellipsoidGeometry = new EllipsoidOutlineGeometry.EllipsoidOutlineGeometry(
      ellipsoidOptions
    )
  ...
  SphereOutlineGeometry.unpack = function (array, startingIndex, result) {
    ...
    result._ellipsoidGeometry = new EllipsoidOutlineGeometry.EllipsoidOutlineGeometry(
      scratchOptions
    )
    return result
  }
