define([
  ...
  function transformToLocal(
    ...
    for (let i = 0; i < vertexCount; ++i) {
      ...
      cartographic.longitude =
        cartographicCenter.longitude + Math$1.CesiumMath.toRadians(scale_x * positions[indexOffset])

      cartographic.latitude =
        cartographicCenter.latitude + Math$1.CesiumMath.toRadians(scale_y * positions[indexOffset1])
  ...
  function decodeI3S(parameters) {
    ...
    if (
      defaultValue.defined(geometryData.uv0s) &&
      defaultValue.defined(geometryData['uv-region'])
    ) {
