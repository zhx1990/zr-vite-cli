define([
   ...
   * @type {number}
   */
  OrientedBoundingBox.packedLength = Matrix3.Cartesian3.packedLength + Matrix3.Matrix3.packedLength
  ...
  OrientedBoundingBox.unpack = function (array, startingIndex, result) {
    ...
    Matrix3.Matrix3.unpack(array, startingIndex + Matrix3.Cartesian3.packedLength, result.halfAxes)
    return result
  }
  ...
  OrientedBoundingBox.fromRectangle = function (
    ...
    const planeXAxis = Matrix3.Cartesian3.cross(planeNormal, planeYAxis, scratchPlaneXAxis)
    ...
    maxX = Matrix3.Cartesian3.dot(
      Plane.Plane.projectPointOntoPlane(plane, horizonCartesian, scratchHorizonProjected),
      planeXAxis
    )
  ...
  OrientedBoundingBox.fromTransformation = function (transformation, result) {
    ...
    result.halfAxes = Matrix3.Matrix3.multiplyByScalar(result.halfAxes, 0.5, result.halfAxes)
    return result
  }
  ...
  OrientedBoundingBox.isOccluded = function (box, occluder) {
    ...
    const sphere = Transforms.BoundingSphere.fromOrientedBoundingBox(box, scratchBoundingSphere)
