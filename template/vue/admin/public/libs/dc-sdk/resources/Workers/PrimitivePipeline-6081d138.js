define([
  ...
  PrimitivePipeline.packCreateGeometryResults = function (items, transferableObjects) {
    ...
    for (let i = 0; i < length; i++) {
      ...
      const validBoundingSphereCV = defaultValue.defined(geometry.boundingSphereCV) ? 1.0 : 0.0
      ...
      const indicesLength = defaultValue.defined(geometry.indices) ? geometry.indices.length : 0
