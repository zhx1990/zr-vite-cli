define(['exports', './Matrix3-41c58dde', './Math-0a2ac845', './Transforms-b527bb09'], function (
  exports,
  Matrix3,
  Math$1,
  Transforms
  ...
  EllipseGeometryLibrary.raisePositionsToHeight = function (positions, options, extrude) {
    ...
    for (let i = 0; i < length; i += 3) {
      ...
      const scaledNormal = Matrix3.Cartesian3.multiplyByScalar(normal, height, scratchCartesian3)
