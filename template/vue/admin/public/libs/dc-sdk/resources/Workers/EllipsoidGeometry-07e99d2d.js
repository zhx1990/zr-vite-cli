define([
  ...
  EllipsoidGeometry.createGeometry = function (ellipsoidGeometry) {
    ...
    slicePartitions = Math.round(
      (slicePartitions * Math.abs(maximumClock - minimumClock)) / Math$1.CesiumMath.TWO_PI
    )
    ...
    const numIndices =
      6 * (indexCount + extraIndices + 1 - (slicePartitions + stackPartitions) * vertexMultiplier)
