define([
  ...
  WindingOrder.validate = function (windingOrder) {
    return (
      windingOrder === WindingOrder.CLOCKWISE || windingOrder === WindingOrder.COUNTER_CLOCKWISE
    )
  }
  ...
  PolygonPipeline.computeSubdivision = function (
    ...
    while (triangles.length > 0) {
      ...
      const v0 = Matrix3.Cartesian3.fromArray(subdividedPositions, i0 * 3, subdivisionV0Scratch)
      const v1 = Matrix3.Cartesian3.fromArray(subdividedPositions, i1 * 3, subdivisionV1Scratch)
      const v2 = Matrix3.Cartesian3.fromArray(subdividedPositions, i2 * 3, subdivisionV2Scratch)

      let t0, t1, t2
      if (hasTexcoords) {
        t0 = Matrix2.Cartesian2.fromArray(subdividedTexcoords, i0 * 2, subdivisionT0Scratch)
        t1 = Matrix2.Cartesian2.fromArray(subdividedTexcoords, i1 * 2, subdivisionT1Scratch)
        t2 = Matrix2.Cartesian2.fromArray(subdividedTexcoords, i2 * 2, subdivisionT2Scratch)
      }
