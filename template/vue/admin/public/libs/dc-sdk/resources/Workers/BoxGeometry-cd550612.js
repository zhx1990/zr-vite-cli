define([
  ...
  BoxGeometry.pack = function (value, array, startingIndex) {
    ...
    Matrix3.Cartesian3.pack(value._maximum, array, startingIndex + Matrix3.Cartesian3.packedLength)
  ...
  BoxGeometry.createGeometry = function (boxGeometry) {
    ...
    if (defaultValue.defined(boxGeometry._offsetAttribute)) {
      ...
      const offsetValue =
        boxGeometry._offsetAttribute === GeometryOffsetAttribute.GeometryOffsetAttribute.NONE
          ? 0
          : 1
