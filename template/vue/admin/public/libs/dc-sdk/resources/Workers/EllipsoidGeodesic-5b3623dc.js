define([
  ...
  './Math-0a2ac845',
], function (exports, Matrix3, Check, defaultValue, Math$1) {
  'use strict'
  ...
  function vincentyInverseFormula(
    ...
    const B =
      (uSquared * (256.0 + uSquared * (uSquared * (74.0 - 47.0 * uSquared) - 128.0))) / 1024.0
  ...
  function computeProperties(ellipsoidGeodesic, start, end, ellipsoid) {
    ...
    ellipsoidGeodesic._start = Matrix3.Cartographic.clone(start, ellipsoidGeodesic._start)
