  ...
  HeightmapTessellator.computeVertices = function (options) {
    ...
    if (!defaultValue.defined(rectangle)) {
      if (isGeographic) {
        ...
        geographicNorth =
          piOverTwo - 2.0 * atan(exp(-nativeRectangle.north * oneOverGlobeSemimajorAxis))
      }
    } else {
    ...
    const fromENU = Transforms.Transforms.eastNorthUpToFixedFrame(relativeToCenter, ellipsoid)
    ...
    if (includeWebMercatorT) {
      southMercatorY =
        WebMercatorProjection.WebMercatorProjection.geodeticLatitudeToMercatorAngle(geographicSouth)
        ...
        if (elementsPerHeight === 1) {
          ...
          if (isBigEndian) {
            for (elementOffset = 0; elementOffset < elementsPerHeight; ++elementOffset) {
              heightSample =
                heightSample * elementMultiplier + heightmap[terrainOffset + elementOffset]
            }
          } else {
    ...
    ;(function () {
      ...
      var LercDecode = (function () {
        ...
        CntZImage.decode = function (input, options) {
          ...
          var noDataValue =
            options.noDataValue !== null ? options.noDataValue : CntZImage.defaultNoDataValue
      ...
      var Lerc2Decode = (function () {
        ...
        var Lerc2Helpers = {
          ...
          readDataOneSweep: function (input, data, OutPixelTypeArray) {
            ...
            var numBytes =
              headerInfo.numValidPixel * Lerc2Helpers.getDataTypeSize(imageType) * numDims
          ...
          isValidPixelValue: function (t, val) {
            ...
            switch (t) {
              ...
              case 5: //uinit 32
                ...
                break
              case 6:
                isValid = val >= -3.4027999387901484e38 && val <= 3.4027999387901484e38
                break
              case 7:
