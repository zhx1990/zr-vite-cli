!(function () {
  ...
  for (let t = 0; 256 > t; t++) {
    let e = t
    for (let t = 0; 8 > t; t++) 1 & e ? (e = (e >>> 1) ^ 3988292384) : (e >>>= 1)
    d[t] = e
  }
  class u {
    constructor(t) {
    ...
    append(t) {
      let e = 0 | this.crc
      for (let n = 0, s = 0 | t.length; s > n; n++) e = (e >>> 8) ^ d[255 & (e ^ t[n])]
      this.crc = e
    }
    get() {
      return ~this.crc
  ...
  const f = {
      ...
      clamp(t, e) {
        ...
        return (
          (e &= 31),
          s > 0 && e && (t[s - 1] = f.partial(e, t[s - 1] & (2147483648 >> (e - 1)), 1)),
          t
        )
      },
      ...
      _shiftRight(t, e, n, s) {
        ...
        for (let r = 0; r < t.length; r++) s.push(n | (t[r] >>> e)), (n = t[r] << (32 - e))
        const r = t.length ? t[t.length - 1] : 0,
          a = f.getPartial(r)
        return s.push(f.partial((e + a) & 31, e + a > 32 ? n : s.pop(), 1)), s
      },
    },
    g = {
      bytes: {
        fromBits(t) {
          const e = f.bitLength(t) / 8,
            n = new r(e)
          let s
          for (let r = 0; e > r; r++) 0 == (3 & r) && (s = t[r / 4]), (n[r] = s >>> 24), (s <<= 8)
          return n
        },
        toBits(t) {
          const e = []
          let n,
            s = 0
          for (n = 0; n < t.length; n++) (s = (s << 8) | t[n]), 3 == (3 & n) && (e.push(s), (s = 0))
  ...
  w.sha1.prototype = {
    ...
    update: function (t) {
      ...
      const n = (e._buffer = f.concat(e._buffer, t)),
        r = e._length,
        a = (e._length = r + f.bitLength(t))
      if (a > 9007199254740991) throw new s('Cannot hash more than 2^53 - 1 bits')
      const c = new i(n)
      let o = 0
      for (
        let t = e.blockSize + r - ((e.blockSize + r) & (e.blockSize - 1));
        a >= t;
        t += e.blockSize
      )
    ...
    _block: function (e) {
      ...
      let i = r[0],
        ...
        h = r[4]
      for (let t = 0; 79 >= t; t++) {
        16 > t || (a[t] = s._S(1, a[t - 3] ^ a[t - 8] ^ a[t - 14] ^ a[t - 16]))
        const e = (s._S(5, i) + s._f(t, c, o, l) + h + a[t] + s._key[n.floor(t / 20)]) | 0
  ...
  const y = {
        ...
        const e = new i(t.buffer),
          s = (t) => {
            ...
            return () => (
              ...
              ((((e << 16) + (t = (18e3 * (65535 & t) + (t >> 16)) & s)) & s) / 4294967296 + 0.5) *
                (n.random() > 0.5 ? 1 : -1)
            )
          }
        for (let r, a = 0; a < t.length; a += 4) {
          const t = s(4294967296 * (r || n.random()))
          ;(r = 987654071 * t()), (e[a / 4] = (4294967296 * t()) | 0)
        }
        return t
      },
    },
    _ = {
      ...
      pbkdf2(t, e, n, r) {
        if (((n = n || 1e4), 0 > r || 0 > n)) throw new s('invalid params to pbkdf2')
        const a = (1 + (r >> 5)) << 2
        let i, c, l, h, p
      ...
      hmacSha1: class {
        constructor(t) {
          ...
          for (let e = 0; r > e; e++) (s[0][e] = 909522486 ^ t[e]), (s[1][e] = 1549556828 ^ t[e])
    ...
    A = class {
      constructor(t) {
        ...
        for (e._key = [(c = t.slice(0)), (o = [])], i = a; 4 * a + 28 > i; i++) {
          let t = c[i - 1]
          ;(i % a == 0 || (8 === a && i % a == 4)) &&
            ((t =
              (n[t >>> 24] << 24) ^
      ...
      _precompute() {
        const t = this._tables[0],
          ...
          a = []
        let i, c, o, l
        for (let t = 0; 256 > t; t++) a[(r[t] = (t << 1) ^ (283 * (t >> 7))) ^ t] = t
        for (let h = (i = 0); !n[h]; h ^= c || 1, i = a[i] || 1) {
          ...
          let p = (16843009 * l) ^ (65537 * o) ^ (257 * c) ^ (16843008 * h),
            d = (257 * r[a]) ^ (16843008 * a)
          for (let n = 0; 4 > n; n++)
            (t[n][h] = d = (d << 24) ^ (d >>> 8)), (e[n][a] = p = (p << 24) ^ (p >>> 8))
        }
      ...
      _crypt(t, e) {
        ...
        let d,
          ...
          m = 4
        for (let t = 0; r > t; t++)
          (d = c[g >>> 24] ^ o[(w >> 16) & 255] ^ l[(y >> 8) & 255] ^ h[255 & _] ^ n[m]),
            (u = c[w >>> 24] ^ o[(y >> 16) & 255] ^ l[(_ >> 8) & 255] ^ h[255 & g] ^ n[m + 1]),
            (f = c[y >>> 24] ^ o[(_ >> 16) & 255] ^ l[(g >> 8) & 255] ^ h[255 & w] ^ n[m + 2]),
            (_ = c[_ >>> 24] ^ o[(g >> 16) & 255] ^ l[(w >> 8) & 255] ^ h[255 & y] ^ n[m + 3]),
            (m += 4),
            (g = d),
            (w = u),
            (y = f)
    ...
    R = class {
      ...
      calculate(t, e, n) {
        ...
        const r = f.bitLength(e)
        for (let r = 0; s > r; r += 4) {
          this.incCounter(n)
          const s = t.encrypt(n)
          ;(e[r] ^= s[0]), (e[r + 1] ^= s[1]), (e[r + 2] ^= s[2]), (e[r + 3] ^= s[3])
        }
        return f.clamp(e, r)
      }
    },
  ...
  class T {
    constructor(t, n, s) {
      e.assign(this, { password: t, signed: n, strength: s - 1, pendingInput: new r(0) })
    }
    async append(e) {
      const n = this
      if (n.password) {
        const r = E(e, 0, S[n.strength] + 2)
        await (async (t, e, n) => {
          await L(t, n, E(e, 0, S[t.strength]))
          const r = E(e, S[t.strength]),
            a = t.keys.passwordVerification
          if (a[0] != r[0] || a[1] != r[1]) throw new s(m)
        })(n, r, n.password),
          (n.password = null),
      ...
      return G(n, e, new r(e.length - I - ((e.length - I) % b)), 0, I, !0)
    }
    flush() {
      const t = this,
        e = t.pendingInput,
      ...
      return { valid: i, data: a }
    }
  }
  class U {
    constructor(t, n) {
      e.assign(this, { password: t, strength: n - 1, pendingInput: new r(0) })
    }
    async append(e) {
      const n = this
      let s = new r(0)
      n.password &&
        ...
        (n.aesCtrGladman = new R(new A(n.keys.key), t.from(D))),
        (n.hmac = new W(n.keys.authentication)))
      const a = new r(s.length + e.length - (e.length % b))
      return a.set(s, 0), G(n, e, a, s.length, 0)
    }
    flush() {
      const t = this
      let e = new r(0)
  ...
  function G(t, e, n, s, a, i) {
    ...
    for (
      ...
      const r = K.toBits(E(e, o, o + b))
      i && t.hmac.update(r)
      const a = t.aesCtrGladman.update(r)
      i || t.hmac.update(a), n.set(K.fromBits(a), o + s)
    }
  ...
  async function L(t, n, s) {
    const a = ((t) => {
        if (void 0 === l) {
          const e = new r((t = unescape(encodeURIComponent(t))).length)
      ...
      i = await ((t, e, n, s, r) =>
        V && H && 'function' == typeof h.subtle.importKey
          ? h.subtle.importKey('raw', e, n, !1, r)
          : _.importKey(e))(0, a, v, 0, C),
      c = await (async (t, e, n) =>
  ...
  function P(t, e) {
    let n = t
    return (
      t.length + e.length && ((n = new r(t.length + e.length)), n.set(t, 0), n.set(e, t.length)), n
    )
  }
  function E(t, e, n) {
  ...
  class M {
    ...
    append(t) {
      ...
      if (e.password) {
        ...
        if (((e.password = null), n[11] != e.passwordVerification)) throw new s(m)
        t = t.subarray(12)
      }
      return x(e, t)
    }
    flush() {
      return { valid: !0, data: new r(0) }
    }
  }
  class j {
    constructor(t, n) {
    ...
    append(t) {
      ...
      if (e.password) {
        e.password = null
        const a = h.getRandomValues(new r(12))
        ;(a[11] = e.passwordVerification),
          (n = new r(t.length + a.length)),
          n.set(F(e, a), 0),
          (s = 12)
      } else (n = new r(t.length)), (s = 0)
  ...
  class $ {
    constructor(
      ...
      e.assign(this, {
        ...
        crc32: r && new u(),
        zipCrypto: i,
        decrypt: h && i ? new M(s, c) : new T(s, r, o),
      })
    }
    async append(t) {
      const e = this
    ...
    async flush() {
      ...
      if ((!t.encrypted || t.zipCrypto) && t.signed) {
        const n = new o(new r(4).buffer)
        if (((e = t.crc32.get()), n.setUint32(0, e), t.signature != n.getUint32(0, !1)))
          throw new s(Z)
      }
      return (
        t.compressed && ((n = (await t.inflate.append(n)) || new r(0)), await t.inflate.flush()),
        { data: n, signature: e }
      )
    }
  }
  class tt {
    ...
    async flush() {
      ...
      let e,
        n = new r(0)
      if ((t.compressed && (n = (await t.deflate.flush()) || new r(0)), t.encrypted)) {
        n = await t.encrypt.append(n)
        const s = t.encrypt.flush()
        e = s.signature
        const a = new r(n.length + s.data.length)
        a.set(n, 0), a.set(s.data, n.length), (n = a)
      }
      return (
  ...
  function st(t, n, s) {
    return class {
      constructor(a) {
        const i = this
        ;(i.codec = new t(e.assign({}, n, a))),
          s(i.codec, (t) => {
            if (i.pendingData) {
              const e = i.pendingData
              ;(i.pendingData = new r(e.length + t.length)),
                i.pendingData.set(e, 0),
                i.pendingData.set(t, e.length)
            } else i.pendingData = new r(t)
          })
      }
      append(t) {
        return this.codec.push(t), a(this)
      }
      flush() {
        return this.codec.push(new r(0), !0), a(this)
      }
    }
    function a(t) {
      if (t.pendingData) {
