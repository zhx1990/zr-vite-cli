...
class DiffuseWallPrimitive extends Overlay {
  ...
  _getPositions() {
    ...
    for (let i = 0; i < this._style.slices; i++) {
      ...
      let point = new Cesium.Cartesian3(x * this._currentRadius, y * this._currentRadius, 0.0)
      pnts.push(Cesium.Matrix4.multiplyByPoint(modelMatrix, point, new Cesium.Cartesian3()))
    }
    pnts.push(pnts[0])
    return pnts
  }
