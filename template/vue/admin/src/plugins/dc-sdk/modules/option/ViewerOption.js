...
class ViewerOption {
  ...
  _setGlobeOption() {
    ...
    Util.merge(globe, {
      ...
      terrainExaggerationRelativeHeight: globeOption?.terrainExaggerationRelativeHeight || 0,
    })
    ...
    if (globeOption?.filterColor) {
      let shaderSource = this._viewer.scene.globe._surfaceShaderSet.baseFragmentShaderSource
