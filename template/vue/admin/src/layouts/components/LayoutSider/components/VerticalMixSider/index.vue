<template>
  <base-dark-mode-container
    class="flex h-full"
    :inverted="theme.sider.inverted"
    @mouseleave="resetFirstDegreeMenus"
  >
    <div class="flex-1-hidden flex-col-stretch h-full">
      <layout-logo :show-title="false" :style="{ height: theme.header.height + 'px' }" />
...
import { useRouterPush, useBoolean } from '@/hooks'
import { translateMenuLabel } from '@/utils'
import { LayoutLogo } from '@/layouts/components'
