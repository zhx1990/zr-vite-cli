...
import { showErrorMsg, showBackendErrorMsg } from './msg'
 ...
 */
export function handleBackendError(backendResult: any, config: Service.BackendResultConfig) {
  ...
  showBackendErrorMsg(backendResult)
